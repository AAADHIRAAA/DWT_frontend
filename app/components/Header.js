...
const Header = () => {
  ...
  const storeFirstLoginTime = async () => {
    try {
      // const storedFirstLoginTimes =
      //   JSON.parse(localStorage.getItem("firstLoginTimes")) || {};
      ...
      // if (
      //   storedFirstLoginTimes[user.id] ||
      //   storedFirstLoginTimes[user.id].date !== currentDate
      // ) {
      //   const timeString = getTimeString(currentTime);
      //   storedFirstLoginTimes[user.id] = {
      //     date: currentDate,
      ...
      //     "firstLoginTimes",
      //     JSON.stringify(storedFirstLoginTimes)
      //   );
      //   console.log("login1");
